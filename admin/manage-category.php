...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <a href="<?= base_url('add-category.php') ?>">
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="<?php base_url('update-category.php?id='.$data['id']); ?>"><button type="button" class="btn btn-success mb-1 ml-4"><i class="icon-pencil5 mr-2"></i>Update</button></a>
                                            <a href="<?php base_url('delete-category.php?id='.$data['id']); ?>"><button type='button' class='btn btn-danger ml-4'><i class='icon-cancel-circle2 mr-2'></i>Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </td>
